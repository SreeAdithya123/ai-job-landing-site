   ...
   return (
     ...
     >
       ...
       <header className="px-10 pt-10 pb-6">
         <h1 className="text-4xl font-light tracking-wide mb-2" style={{ color: theme.primary }}>
       ...
       <main className="px-10 pb-10">
         ...
         {data.experience.length > 0 && (
           <section className="mb-6">
             <h2 className="text-xs font-semibold uppercase tracking-widest mb-4" style={{ color: theme.accent }}>
               Experience
             </h2>
               ...
               {data.experience.map((exp) => (
                 <div key={exp.id} className="border-l-2 pl-4" style={{ borderColor: theme.accent }}>
                   <div className="flex justify-between items-baseline">
                     <h3 className="font-medium" style={{ color: theme.primary }}>{exp.role}</h3>
             ...
             <div className="space-y-3">
               {data.education.map((edu) => (
                 <div key={edu.id} className="flex justify-between">
                   <div>
                     <h3 className="font-medium text-sm" style={{ color: theme.primary }}>{edu.degree}</h3>
           ...
           <section className="mb-6">
             ...
             <div className="space-y-3">
               {data.projects.map((project) => (
                 <div key={project.id}>
                   <h3 className="font-medium text-sm" style={{ color: theme.primary }}>{project.title}</h3>
         ...
         <div className="grid grid-cols-2 gap-6">
           {data.certifications.length > 0 && (
             <section>
               <h2 className="text-xs font-semibold uppercase tracking-widest mb-3" style={{ color: theme.accent }}>
                 Certifications
               </h2>
