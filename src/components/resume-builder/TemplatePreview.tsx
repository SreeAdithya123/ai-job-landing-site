 ...
 export const TemplatePreview: React.FC<TemplatePreviewProps> = ({
   ...
   return (
     <div className="min-h-screen flex flex-col lg:flex-row">
       {/* Controls Sidebar */}
       <motion.div
         className="lg:w-80 bg-slate-900 border-b lg:border-b-0 lg:border-r border-slate-800 p-6"
       ...
       >
         ...
         <h2 className="text-xl font-bold text-white mb-6">Customize Resume</h2>
         ...
         <div className="space-y-6">
               ...
               {colorOptions.map((color) => (
                 <button
                   ...
                   className={`w-8 h-8 rounded-full ${color.color} transition-all ${
                     settings.colorTheme === color.value ? 'ring-2 ring-white ring-offset-2 ring-offset-slate-900' : ''
                   }`}
                   title={color.label}
                 />
               ))}
           ...
           {/* Font Style */}
           <div className="space-y-2">
             <label className="text-sm text-slate-400">Font Style</label>
             <Select
             ...
             >
               ...
               <SelectContent className="bg-slate-800 border-slate-700">
                 ...
                 <SelectItem value="sora" className="text-white">Sora</SelectItem>
               </SelectContent>
             </Select>
           </div>
         </div>
       ...
       {/* Preview Area */}
       <div className="flex-1 bg-slate-800/50 p-6 lg:p-12 overflow-auto">
         <motion.div
