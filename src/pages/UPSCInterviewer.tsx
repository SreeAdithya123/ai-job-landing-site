      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-center space-x-4">
            {!isInterviewActive ? <>
                <motion.button className="flex items-center space-x-3 px-6 py-3 bg-slate-700/80 backdrop-blur-sm border border-slate-600 text-slate-300 rounded-lg hover:bg-slate-600/80 transition-all duration-200" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
            ...
            duration: 0.3
                ...
                <button onClick={handleExitInterview} className="flex items-center space-x-3 px-8 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg hover:shadow-lg transition-all duration-200 font-medium">
                  <LogOut className="h-5 w-5" />
          ...
          {transcript.length > 0 && <div className="mt-8 bg-slate-800/30 backdrop-blur-md border border-slate-700/50 rounded-xl p-6">
              ...
              <div className="h-64 overflow-y-auto bg-slate-900/50 rounded-lg p-4 space-y-3">
                {transcript.map((entry, index) => <motion.div key={index} initial={{
              opacity: 0,
              y: 10
            }} animate={{
              opacity: 1,
              ...
              <div className="mt-4 flex justify-between items-center">
                <button onClick={() => setTranscript([])} className="text-sm text-slate-400 hover:text-slate-200 transition-colors">
                  Clear Transcript
                </button>
